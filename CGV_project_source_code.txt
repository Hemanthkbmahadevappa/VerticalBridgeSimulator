...
void screen1()
{
        glClearColor(0.5,0.2,0.0,0.6);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(1.0,1.0,1.0);
    char str1[]="           SJB  INSTITUTE  OF  TECHNOLOGY";
    drawstring(str1,-0.7,0.9,0.0);
    glColor3f(0.9,0.9,0.9);
    char str2[]="DEPARTMENT  OF  COMPUTER  SCIENCE  AND  ENGINEERING";
    drawstring(str2,-0.9,0.8,0.0);
    glColor3f(0.8,0.8,0.8);
    char str3[]="A  MINI  PROJECT  ON";
    drawstring(str3,-0.5,0.7,0.0);
    glColor3f(1.0,0.7,0.7);
    char str4[]="-*-   VERTICAL  LIFT  BRIDGE  SIMULATION   -*-";
    drawstring(str4,-0.85,0.6,0.0);
    glColor3f(0.2,0.8,0.5);
    char str5[]="BY  :";
    drawstring(str5,-0.7,0.5,0.0);
    glColor3f(1.0,1.0,0.0);
    char str6[]="HARSHAVARDHANA V    (1JB20CS036)";
    drawstring(str6,-0.7,0.4,0.0);
    char str7[]="HEMANTHKUMAR BM     (1JB20CS037)";
    drawstring(str7,-0.7,0.3,0.0);
    glColor3f(0.2,0.8,0.5);
    char str8[]="GUIDES  :";
    drawstring(str8,-0.7,0.1,0.0);
    glColor3f(1.0,1.0,0.0);
    char str9[]="Dr. BINDYA M K   (Assoc.prof. Dept of CSE)";
    drawstring(str9,-0.7,0.0,0.0);
    char str10[]="Mrs. JYOTHI P K    (Asst.prof. Dept of CSE)";
    drawstring(str10,-0.7,-0.1,0.0);
    glColor3f(1.0,0.9,1.0);
    char str11[]="INSTRUCTIONS ";
    drawstring(str11,-0.7,-0.5,0.0);
    char str12[]="----------------";
    drawstring(str12,-0.8,-0.55,0.0);
    char str13[]=" * * *   PRESS     -ENTER -     TO  START  AND     -ESC-     TO EXIT   * * *";
    drawstring(str13,-1.3,-0.7,0.0);
    char str14[]="PRESS  -S-     TO  START  ANIMATION   AND  PRESS    -T-    TO  STOP  ANIMATION";
    drawstring(str14,-1.55,-0.85,0.0);
    glFlush();
}
...
void screen3()
{
   glClearColor(1.0,0.5,0.0,0.0);
    ...
    char str1[]="* * *  THANK YOU  * * * ";
    drawstring(str1,-0.5,0.2,0.0);
    char str2[]=" ------------------------- ";
    drawstring(str2,-0.6,0.1,0.0);
    glFlush();
}
